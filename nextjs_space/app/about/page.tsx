      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="text-lg text-gray-700 mb-4">
            At Energenius, we believe in delivering professional-grade solar generators at honest prices with
            exceptional support. We eliminate the frustrations customers experience with other brands through
            transparent pricing, superior warranty coverage, and responsive U.S.-based customer service.
          </p>
          <p className="text-lg text-gray-700 mb-4">
