// Test script to verify capacity conversions for all products
const { parseCapacityToWattHours, convertAmpHoursToWattHours } = require('./lib/spec-benefits.ts');

// Test data from the products
const testCases = [
